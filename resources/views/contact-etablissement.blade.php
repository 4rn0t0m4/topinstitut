<x-layouts.app :title="'Contacter ' . $establishment->name">
    <div class="max-w-2xl mx-auto px-4 py-8">
        <h1 class="text-2xl font-bold mb-6">Contacter {{ $establishment->name }}</h1>
        ...
        <form method="POST" action="{{ route('contact.etablissement.send', $establishment) }}" class="bg-white rounded-lg shadow-sm border p-6">
            @csrf
            <x-honeypot />
            <div class="mb-4">
